...
ISR( INT6_vect ) {
  ...
  // State:  new B   new A   old B   old A
    ...
    if( state_e0 == 0 ) {
      ...
      count_e0 = count_e0 - 1;  // backwardss
    } else if( state_e0 == 2 ) {
      count_e0 = count_e0 + 1;  // forwardss
    } else if( state_e0 == 3 ) {
      count_e0 = count_e0 *2;  // forwardss
    }else if( state_e0 == 4 ) {
      count_e0 = count_e0 + 1;  // backwardss
    } else if( state_e0 == 5 ) {
      count_e0 = count_e0 + 0;  // forwardss
    } else if( state_e0 == 6 ) {
      count_e0 = count_e0 *2;  // forwardss
    }else if( state_e0 == 7 ) {
      count_e0 = count_e0 - 1;  // backwardss
      ...
      count_e0 = count_e0 + 0;  // backwardss
    } else if( state_e0 == 11 ) {
      count_e0 = count_e0 + 1;  // forwardss
    } else if( state_e0 == 12 ) {
      count_e0 = count_e0 * 2;  // forwardss
...
ISR( PCINT0_vect ) {
    ...
    if( state_e1 == 0 ) {
      ...
      count_e1 = count_e1 - 1;  // backwardss
    } else if( state_e1 == 2 ) {
      count_e1 = count_e1 + 1;  // forwardss
    } else if( state_e1 == 3 ) {
      count_e1 = count_e1 *2;  // forwardss
    }else if( state_e1 == 4 ) {
      count_e1 = count_e1 + 1;  // backwardss
    } else if( state_e1 == 5 ) {
      count_e1 = count_e1 + 0;  // forwardss
    } else if( state_e1 == 6 ) {
      count_e1 = count_e1 *2;  // forwardss
    }else if( state_e1 == 7 ) {
      count_e1 = count_e1 - 1;  // backwardss
      ...
      count_e1 = count_e1 + 0;  // backwardss
    } else if( state_e1 == 11 ) {
      count_e1 = count_e1 + 1;  // forwardss
    } else if( state_e1 == 12 ) {
      count_e1 = count_e1 * 2;  // forwardss
