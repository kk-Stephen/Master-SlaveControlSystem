...
for i in range(5):
    led = os.path.normpath(
        "D:\Github\Master-SlaveControlSystem\data/accuracy/straight/w_b" + "/leader" + str(i) + ".csv")
    foll = os.path.normpath(
        "D:\Github\Master-SlaveControlSystem\data/accuracy/straight/w_b" + "/follower" + str(i) + ".csv")
